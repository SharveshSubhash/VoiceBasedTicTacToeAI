# -*- coding: utf-8 -*-
"""
Created on Sun May 30 22:17:19 2021
...
def insertLetter(letter, pos):
    if spaceIsFree(pos):
        ...
        print("Position is not specified/ Place is filled already")
def spaceIsFree(pos):
    return board[pos] == ' '
...
while True:
    ...
    if 'yes' in answer:
       ...
       print('-----------------------------------')
       main()
    elif 'optimise' in answer:
        print("\n Wait! I will optimize my code with your playing style.\n")
        print("\n Win this new Game if you can! I Challenge you! \n ")
        import TicTacToeMIN
        exec(TicTacToeMIN)
        break
    else:
        print("See you! Tic Tac Toe Master in here!")
        break
