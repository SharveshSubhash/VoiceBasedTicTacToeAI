# -*- coding: utf-8 -*-
"""
Created on Mon May 31 14:51:59 2021
...
# board is now: [' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ']
def Voiceinput():
    print("Please tell the position of the your 'X'. ")
    with sr.Microphone() as source:
        audio=r2.listen(source)
        reg=(r2.recognize_google(audio))
        print("You have said:",reg)
    return reg
...
while True:
    ...
    if answer.lower() == 'y' or answer.lower == 'yes':
        ...
        print("Wait! I will optimize my code with your playing style.")
        import TicTacToeMIN
        exec(TicTacToeMIN)
        break
